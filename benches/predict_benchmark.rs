...
fn predict_original(c: &mut Criterion) {
    benchmark_predict(c, ESKF::predict_original, "predict_original")
}
...
fn predict_optimized_tr(c: &mut Criterion) {
    benchmark_predict(c, ESKF::predict_optimized, "predict_optimized_tr")
}
